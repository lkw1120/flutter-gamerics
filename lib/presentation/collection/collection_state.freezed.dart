...
switch (_that) {
case _CollectionState():
return $default(_that.selectedTabIndex,_that.favoritesItems,_that.playingItems,_that.finishedItems,_that.isLoadingFavorites,_that.isLoadingPlaying,_that.isLoadingFinished,_that.errorMessage);}
}
